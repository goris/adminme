...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { due_date: @debt.due_date, payed: @debt.payed, quantity: @debt.quantity, term: @debt.term }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { due_date: @debt.due_date, payed: @debt.payed, quantity: @debt.quantity, term: @debt.term }
    assert_redirected_to debt_path(assigns(:debt))
  end
